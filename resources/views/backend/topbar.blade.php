            ...
            <ul class="nav navbar-nav">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="message" role="tabpanel" aria-labelledby="message-tab">
                                    ...
                                    <div class="media media-sm p-4 mb-0">
                                        <div class="media-sm-wrapper">
                                            <a href="user-profile.html">
                                                <img src="{{asset('backend/images/user/unnamed.jpg')}}" alt="User Image">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                            <a href="user-profile.html">
                ...
                <li class="dropdown user-menu">
                    <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <img src="{{asset('backend/images/user/unnamed.jpg')}}" class="user-image rounded-circle" alt="User Image" />
                        <span class="d-none d-lg-inline-block">Habib</span>
                    </button>
...
{{--                                        <i class="mdi mdi-logout"><span>Logout</span></i>--}}
...
{{--                        </li>--}}
                        ...
                        <li class="dropdown-footer">
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <a href="{{route('logout')}}" class="dropdown-link-item" onclick="event.preventDefault();
                                            this.closest('form').submit();">
