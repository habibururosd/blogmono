                                    ...
                                    @foreach($posts as $post)
                                        <div class="item">
                                            <div class="slider-post post-height-1">
                                                <a href="{{route('blog.details',$post->slug)}}" class="news-image">
                            ...
                            @foreach($latestPosts as $latestPost)
                                <div class="col-xs-6 col-sm-12 col-md-12 thm-padding">
                                    <div class="slider-post post-height-2">
                                        <a href="{{route('blog.details',$latestPost->slug)}}" class="news-image"><img src="{{asset('storage/'.$latestPost->image)}}" alt="" class="img-responsive"></a>
                                        <div class="post-text">
                                            <span class="post-category">Travel</span>
                                            <h4><a href="{{route('blog.details',$latestPost->slug)}}">{{$post->title}}</a></h4>
                                            <ul class="authar-info">
            ...
            <div class="row row-m">
                ...
                <div class="col-sm-8 col-p main-content">
                    <div class="theiaStickySidebar">
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-sm-6 main-post-inner bord-right">
                                                <article>
                                                    <figure>
                                                        <a href="#"><img src="{{asset('frontend/images/340x215-1.jpg')}}" height="242" width="345" alt="" class="img-responsive"></a>
                                                ...
                                                <div class="news-list">
                                                    <div class="news-list-item">
                                                        <div class="img-wrapper">
                                                            <a href="#" class="thumb">
                                                                <img src="{{asset('frontend/images/115x85-1.jpg')}}" alt="" class="img-responsive">
                                                                <div class="link-icon">
                                                    ...
                                                    <div class="news-list-item">
                                                        <div class="img-wrapper">
                                                            <a href="#" class="thumb">
                                                                <img src="{{asset('frontend/images/115x85-2.jpg')}}" alt="" class="img-responsive">
                                                                <div class="link-icon">
                                                    ...
                                                    <div class="news-list-item">
                                                        <div class="img-wrapper">
                                                            <a href="#" class="thumb">
                                                                <img src="{{asset('frontend/images/115x85-3.jpg')}}" alt="" class="img-responsive">
                                                                <div class="link-icon">
                                                                    <i class="fa fa-camera"></i>
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="news-list-item">
                                                        <div class="img-wrapper">
                                                            <a href="#" class="thumb">
                                                                <img src="{{asset('frontend/images/115x85-4.jpg')}}" alt="" class="img-responsive">
                                                                <div class="link-icon">
                                                                    <i class="fa fa-play"></i>
                                                                </div>
                                                            </a>
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-sm-6 main-post-inner bord-right">
                                                <article>
                                                    <figure>
                                                        <a href="#"><img src="{{asset('frontend/images/340x215-2.jpg')}}" height="242" width="345" alt="" class="img-responsive"></a>
                                                        <span class="post-category">Business</span>
                                                    </figure>
                                                    <div class="post-info">
                                                        <h3><a href="#">Fusce ac orci sagittis mattis magna ultrices libero</a></h3>
                        ...
                        <!-- START ADVERTISEMENT -->
                        <div class="add-inner">
                            <img src="frontend/images/add728x90-1.jpg" class="img-responsive" alt="">
                        </div>
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-sm-6 main-post-inner bord-right">
                                                <article>
                                                    <figure>
                                                        <a href="#"><img src="{{asset('frontend/images/340x215-3.jpg')}}" height="242" width="345" alt="" class="img-responsive"></a>
                                                        <span class="post-category">Travel</span>
                                                    </figure>
                                                    <div class="post-info">
                                                        <h3><a href="#">Fusce ac orci sagittis mattis magna ultrices libero</a></h3>
                                                    ...
                                                    <div class="row row-margin">
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                            <div class="grid-item">
                                                                <div class="grid-item-img">
                                                                    <a href="#">
                                                                        <img src="{{asset('frontend/images/165x110-1.jpg')}}" class="img-responsive" alt="">
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                            <div class="grid-item">
                                                                <div class="grid-item-img">
                                                                    <a href="#">
                                                                        <img src="{{asset('frontend/images/165x110-2.jpg')}}" class="img-responsive" alt="">
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                            <div class="grid-item">
                                                                <div class="grid-item-img">
                                                                    <a href="#">
                                                                        <img src="{{asset('frontend/images/165x110-3.jpg')}}" class="img-responsive" alt="">
                                                                        <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                            <div class="grid-item">
                                                                <div class="grid-item-img">
                                                                    <a href="#">
                                                                        <img src="{{asset('frontend/images/165x110-4.jpg')}}" class="img-responsive" alt="">
                                                                        <div class="link-icon"><i class="fa fa-play"></i></div>
                                                                    </a>
                                                                </div>
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-sm-6 main-post-inner bord-right">
                                                <article>
                                                    <figure>
                                                        <a href="#"><img src="{{asset('frontend/images/340x215-4.jpg')}}" height="242" width="345" alt="" class="img-responsive"></a>
                                                        <span class="post-category">Travel</span>
                                                    </figure>
                                                    <div class="post-info">
                                                        <h3><a href="#">Fusce ac orci sagittis mattis magna ultrices libero</a></h3>
                                                    ...
                                                    <div class="row row-margin">
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                            <div class="grid-item">
                                                                <div class="grid-item-img">
                                                                    <a href="#">
                                                                        <img src="{{asset('frontend/images/165x110-5.jpg')}}" class="img-responsive" alt="">
                                                                        <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                    </a>
                                                                </div>
                                                                <h5><a href="#" class="title">Lorem Ipsum is simply dummy text of the printing.</a></h5>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                            <div class="grid-item">
                                                                <div class="grid-item-img">
                                                                    <a href="#">
                                                                        <img src="{{asset('frontend/images/165x110-6.jpg')}}" class="img-responsive" alt="">
                                                                        <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                    </a>
                                                                </div>
                                                                <h5><a href="#" class="title">It is a long established fact that a reader will be distracted by</a></h5>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                            <div class="grid-item">
                                                                <div class="grid-item-img">
                                                                    <a href="#">
                                                                        <img src="{{asset('frontend/images/165x110-7.jpg')}}" class="img-responsive" alt="">
                                                                        <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                    </a>
                                                                </div>
                                                                <h5><a href="#" class="title">There are many variations of passages of Lorem Ipsum.</a></h5>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                                            <div class="grid-item">
                                                                <div class="grid-item-img">
                                                                    <a href="#">
                                                                        <img src="{{asset('frontend/images/165x110-8.jpg')}}" class="img-responsive" alt="">
                                                                        <div class="link-icon"><i class="fa fa-camera"></i></div>
                                                                    </a>
                                                                </div>
                                                                <h5><a href="#" class="title">Contrary to popular belief, Lorem Ipsum is not simply random text.</a></h5>
                ...
                <div class="col-sm-4 col-p rightSidebar">
                    <div class="theiaStickySidebar">
                        ...
                        <!-- START ADVERTISEMENT -->
                        <div class="add-inner">
                            <img src="{{asset('frontend/images/add320x270-1.jpg')}}" class="img-responsive" alt="">
                        </div>
                        <!-- END OF /. ADVERTISEMENT -->
                        <!-- START NAV TABS -->
                        ...
                        <div id="featured-owl" class="owl-carousel">
                            <div class="item">
                                <div class="featured-post">
                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/featured-620x370-1.jpg')}}" alt="" class="img-responsive"></a>
                                    <div class="reatting">
                            ...
                            <div class="item">
                                <div class="featured-post">
                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/featured-620x370-2.jpg')}}" alt="" class="img-responsive"></a>
                                    <div class="reatting">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                            ...
                            <div class="item">
                                <div class="featured-post">
                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/featured-620x370-3.jpg')}}" alt="" class="img-responsive"></a>
                                    <div class="reatting">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                            ...
                            <div class="item">
                                <div class="featured-post">
                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/featured-620x370-4.jpg')}}" alt="" class="img-responsive"></a>
                                    <div class="reatting">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                            ...
                            <div class="item">
                                <div class="featured-post">
                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/featured-620x370-5.jpg')}}" alt="" class="img-responsive"></a>
                                    <div class="reatting">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
            ...
            <div class="row row-m">
                <div class="col-sm-8 main-content col-p">
                    <div class="theiaStickySidebar">
                                ...
                                <div class="post-slider owl-carousel owl-theme">
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-sm-6 main-post-inner bord-right">
                                                <div class="more-post">
                                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/620x370-1.jpg')}}" alt="" class="img-responsive"></a>
                                                ...
                                                <div class="more-post">
                                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/620x370-2.jpg')}}" alt="" class="img-responsive"></a>
                                                    <div class="reatting">
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="more-post">
                                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/620x370-3.jpg')}}" alt="" class="img-responsive"></a>
                                                    <div class="reatting">
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                ...
                                                <div class="more-post">
                                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/620x370-4.jpg')}}" alt="" class="img-responsive"></a>
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-sm-6 main-post-inner bord-right">
                                                <div class="more-post">
                                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/620x370-5.jpg')}}" alt="" class="img-responsive"></a>
                                                    <div class="progressber" data-percent="80"></div>
                                                    <div class="post-text">
                                                        <span class="post-category">Business</span>
                                                        <h4><a href="#">Lorem Ipsum is simply dummy text of the printing</a></h4>
                                                ...
                                                <div class="more-post">
                                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/620x370-6.jpg')}}" alt="" class="img-responsive"></a>
                                                    <div class="reatting">
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="more-post">
                                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/620x370-7.jpg')}}" alt="" class="img-responsive"></a>
                                                    <div class="reatting">
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                        <i class="fa fa-star"></i>
                                                ...
                                                <div class="more-post">
                                                    <a href="#" class="news-image"><img src="{{asset('frontend/images/620x370-8.jpg')}}" alt="" class="img-responsive"></a>
                                                    <div class="progressber" data-percent="60"></div>
                                                    <div class="post-text">
                                                        <span class="post-category">Business</span>
                                                        <h4><a href="#">Lorem Ipsum is simply dummy text of the printing</a></h4>
                        ...
                        <!-- START ADVERTISEMENT -->
                        <div class="add-inner">
                            <img src="{{asset('frontend/images/add728x90-1.jpg')}}" class="img-responsive" alt="">
                        </div>
                        <!-- END OF /. ADVERTISEMENT -->
                        <!-- START CARD POST -->
                        <div class="row row-m">
                                ...
                                <div class="posts card-post">
                                    <div class="post-grid post-grid-item">
                                        <figure class="posts-thumb">
                                            ...
                                            <a href="#"><img src="{{asset('frontend/images/378x270-1.jpg')}}" alt=""></a>
                                        </figure>
                                        <div class="posts-inner">
                                            <a href="#" class="posts-link"></a>
                                            <h6 class="posts-title"><a href="#">The Alchemists team is appearing in L.A. Beach for charity</a></h6>
                                            <ul class="authar-info">
                                                <li><i class="ti-timer"></i> May 15, 2016</li>
                                                <li class="like"><a href="#"><i class="ti-thumb-up"></i>15 likes</a></li>
                                            </ul>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisi nel elit, sed do eiusmod tempor incididunt ut labore et dolore
                                                magna aliqua. Ut enim ad mini veniam, quis nostrud en derum sum laborem.
                                            </p>
                                        </div>
                                        <div class="posts__footer card__footer">
                                            <div class="post-author">
                                                <figure class="post-author-avatar hidden-xs">
                                                    <img src="{{asset('frontend/images/avatar-1.jpg')}}" alt="Post Author Avatar">
                                                </figure>
                                            ...
                                            <ul class="post-meta">
                                                ...
                                                <li class="meta-item "><a href="#"><i class="ti-heart"></i> 530</a></li>
                                                <li class="meta-item "><a href="#"><i class="ti-comments"></i> 18</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="posts">
                                    <ul>
                                        <li class="post-grid">
                                            <div class="posts-inner">
                                                <span class="post-category">National</span>
                                                <h6 class="posts-title"><a href="#">Trainings are getting really hard reaching the final</a></h6>
                                                <ul class="authar-info">
                                                    <li><i class="ti-timer"></i> May 15, 2016</li>
                                                    <li class="like"><a href="#"><i class="ti-thumb-up"></i>15 likes</a></li>
                                                </ul>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisi ng elit, sed do eiusmod tempor incididunt ut labore...</p>
                                            </div>
                                        </li>
                                        <li class="post-grid">
                                            <div class="posts-inner">
                                                <span class="post-category">National</span>
                                                <h6 class="posts-title"><a href="#">The victory againts The Sharks brings us closer to the Final</a></h6>
                                                <ul class="authar-info">
                                                    <li><i class="ti-timer"></i> May 15, 2016</li>
                                                    <li class="like"><a href="#"><i class="ti-thumb-up"></i>15 likes</a></li>
                                                </ul>
                                        ...
                                        <li class="post-grid hidden-sm">
                                            <div class="posts-inner">
                                                <span class="post-category">National</span>
                                                <h6 class="posts-title"><a href="#">The next match against The Clovers will be this Friday</a></h6>
                                                <ul class="authar-info">
                                                    <li><i class="ti-timer"></i> May 15, 2016</li>
                                                    <li class="like"><a href="#"><i class="ti-thumb-up"></i>15 likes</a></li>
                                                </ul>
                ...
                <div class="col-sm-4 rightSidebar col-p">
                    <div class="theiaStickySidebar">
                                ...
                                <div class="games-result-main">
                                    ...
                                    <div class="games-result-team">
                                        <div class="games-result-team-logo">
                                            <a href="#"><img src="{{asset('frontend/images/game_results_logo_1.png')}}" class="img-responsive" alt=""></a>
                                        </div>
                                    ...
                                    <div class="games-result-team">
                                        <div class="games-result-team-logo">
                                            <a href="#"><img src="{{asset('frontend/images/game_results_logo_2.png')}}" class="img-responsive" alt=""></a>
                                        </div>
                                        <div class="games-result-team-info">
                        ...
                        <!-- START ADVERTISEMENT -->
                        <div class="add-inner">
                            <img src="frontend/images/add320x270-1.jpg" class="img-responsive" alt="">
                        </div>
                        <!-- END OF /. ADVERTISEMENT -->
                    </div>
                </div>
                            ...
                            <div class="post-inner">
                                ...
                                <div class="post-body">
                                    <div class="news-list-item articles-list">
                                        <div class="img-wrapper">
                                            <a href="#" class="thumb"><img src="{{asset('frontend/images/218x150-1.jpg')}}" alt="" class="img-responsive"></a>
                                        </div>
                                        <div class="post-info-2">
                                    ...
                                    <div class="news-list-item articles-list">
                                        <div class="img-wrapper">
                                            <a href="#" class="thumb"><img src="{{asset('frontend/images/218x150-2.jpg')}}" alt="" class="img-responsive"></a>
                                        </div>
                                        <div class="post-info-2">
                                            <h4><a href="#" class="title">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece</a></h4>
                                            <ul class="authar-info">
                                                <li><i class="ti-timer"></i> May 15, 2016</li>
                                                <li class="like"><a href="#"><i class="ti-thumb-up"></i>15 likes</a></li>
                                            </ul>
                                    ...
                                    <div class="news-list-item articles-list">
                                        <div class="img-wrapper">
                                            <a href="#" class="thumb"><img src="{{asset('frontend/images/218x150-3.jpg')}}" alt="" class="img-responsive"></a>
                                        </div>
                                        <div class="post-info-2">
                                    ...
                                    <div class="news-list-item articles-list">
                                        <div class="img-wrapper">
                                            <a href="#" class="thumb"><img src="{{asset('frontend/images/218x150-4.jpg')}}" alt="" class="img-responsive"></a>
                                        </div>
                                        <div class="post-info-2">
                                    ...
                                    <div class="news-list-item articles-list">
                                        <div class="img-wrapper">
                                            <a href="#" class="thumb"><img src="{{asset('frontend/images/340x215-1.jpg')}}" alt="" class="img-responsive"></a>
                                        </div>
                                        <div class="post-info-2">
